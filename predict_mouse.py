...
parser.add_argument('--in_folder', type=str, default='', required=True, help='Folder path containing FASTA files')
parser.add_argument('--out_folder', type=str, default='', required=True)
